          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="user" class="navbar-brand d-none d-sm-inline-block">
                  ...
                  <div class="table-responsive">
                    <table border="1" id="datatable1" style="width: 100%;" class="table">
                      <thead>
                        ...
                        <form action="{{ url('/acc').'/'.$masuk->waktu}}" method="POST">
                          {{ csrf_field() }}
                          <tr>
                            ...
                            <td><label>SPV</label>
                              ...
                              <td>{{$masuk->point}}</td>
                              <th><button style="background-color: green;" type="submit">Proses!</button></th>
                            </form>
                            <form action="{{ url('/reject').'/'.$masuk->waktu}}" method="POST" >
                              {{ csrf_field() }}
                              <th><button style="background-color: red;" type="submit">Totak!</button></th>
                            </form>
                            </tr>
                          @endforeach
                      </tbody>
